...
w_ref=(100/60)*2*np.pi # radain/sec 

kp_w = 20 # Proportional gain
ki_w = 10 # Integral gain
PIController_w=PIController(kp=kp_id, ki=ki_id, setpoint=w_ref) 
